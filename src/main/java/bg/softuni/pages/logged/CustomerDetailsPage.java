...
public class CustomerDetailsPage extends BasePage {
    ...
    public final String CUSTOMER_DETAILS_PAGE_HEADER = "Customer Details";

    public final WebElement customerDetailsTitle = driver.findElement(By.cssSelector("h2.text-center.text-white"));
